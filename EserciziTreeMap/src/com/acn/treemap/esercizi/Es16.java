...
public class Es16 {
	...
	public static void main(String[] args) {
		//16. Scrivere un programma Java per ottenere una mappatura chiave-valore associata alla chiave più grande, 
		// strettamente inferiore alla chiave data. Restituisce null se non esiste tale chiave.
