...
public class Es25 {
	...
	public static void main(String[] args) {
		// 25. Scrivere un programma Java per ottenere una mappatura chiave-valore associata alla chiave minima 
		// maggiore o uguale alla chiave data. Restituisce null se non esiste tale chiave.
		...
		System.out.println(map.higherEntry(chiaveData));
