...
public class Es24 {
	...
	public static void main(String[] args) {
		...
		// 24. Scrivere un programma Java per ottenere una porzione di una mappa le cui chiavi sono maggiori 
		// di una determinata chiave.
		...
		System.out.println(map.tailMap(chiaveData, false));
